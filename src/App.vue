...
const isProjectOrStudy = computed(() => {
 return route.path.startsWith('/project') || route.path.startsWith('/study') || route.path.startsWith('/articles')
})
</script>
...
<template>
  <div id="app">
    ...
    <AppHeader />
    <!-- 主内容区域 -->
    <main class="main-content" :class="{ 'no-padding': isHome, 'transparent-bottom': isProjectOrStudy }">
      <router-view />
    </main>
    <!-- 页脚 -->
