...
const { currentSong, isPlaying, togglePlay, toggleMute, isMuted, skipToPrev, skipToNext } = useAudioPlayer()
  ...
  >
    ...
    <div class="mini-content" v-if="isExpanded">
      ...
      <div class="mini-info" v-if="currentSong">
        <img :src="currentSong.cover" :alt="currentSong.name" class="mini-cover" />
...
@keyframes barGlow {
  0%, 100% { box-shadow: 0 0 12px rgba(99, 102, 241, 0.2), 0 0 24px rgba(99, 102, 241, 0.1); }
  50% { box-shadow: 0 0 16px rgba(99, 102, 241, 0.35), 0 0 32px rgba(99, 102, 241, 0.15); }
}
