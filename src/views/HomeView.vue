  ...
  <div class="home-wrapper" :class="{ loaded: isLoaded }">
    <section class="hero-section" :style="{ height: sectionHeight + 'px' }">
      ...
      <div class="content">
        <div class="text-content">
          ...
          <p class="subtitle scroll-animate fade-up delay-4">
            天地一指也 · 万物一马也
          </p>
        </div>
      </div>
    ...
    >
      ...
      <div class="blog-section">
        <div class="blog-header">
          ...
          <p class="blog-subtitle scroll-animate fade-up delay-1">
            记录技术与生活
          </p>
    ...
    >
      ...
      <div class="links-content">
        ...
        <p class="links-subtitle scroll-animate fade-up delay-1">
          常用工具与平台
        </p>
